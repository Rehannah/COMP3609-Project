...
public class SoundManager {				// a Singleton class
	...
	private SoundManager () {
		...
		// Clip clip = loadClip("BatBallGame-TileMap-FSEM/sounds/background.wav");
		// clips.put("background", clip);		// background theme sound

		// Clip clip = loadClip("BatBallGame-TileMap-FSEM/sounds/hitSound.wav");
		// clips.put("hit", clip);			// played when player's sprite collides 
		// 					//   with another sprice

		// clip = loadClip("BatBallGame-TileMap-FSEM/sounds/appearSound.wav");
		// clips.put("appear", clip);		// played when a special sprite 
		// 					//   makes an appearance

		// clip = loadClip("BatBallGame-TileMap-FSEM/sounds/BirdSound.wav");
